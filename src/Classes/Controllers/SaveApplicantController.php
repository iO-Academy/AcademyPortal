    ...
    function __invoke(Request $request, Response $response)
    {
        ...
        if ($_SESSION['loggedIn'] === true) {
            ...
            $validatedApplicationData = [
                ...
                'cohort' => filter_var($newApplicationData['cohort'], FILTER_SANITIZE_STRING),
                ...
                'hearAbout' => filter_var($newApplicationData['hearAbout'], FILTER_SANITIZE_STRING),
