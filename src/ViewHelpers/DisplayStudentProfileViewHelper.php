    ...
    public static function outputApplicant(CompleteApplicantEntity $applicant): string
    {
        return '<section>
                 ...
                 <section>
                    ...
                    <p class="detail" id="eligible">Eligible to study in the UK: ' . '<span>'.($applicant->getEligible() === 1 ? 'Yes' : 'No'). '</span></p>
                    <p class="detail" id="eighteenPlus">Over 18 years: ' . '<span>'.($applicant->getEighteenPlus() === 1 ? 'Yes' : 'No'). '</span></p>
                    <p class="detail">Finance: <span id="finance">' . ($applicant->getFinance() === 1 ? 'Yes' : 'No') . '</span></p>
                ...
                <section>
                    <h4>Assessment</h4>
                    <p class="detail">Assessment day: <span id="assessmentDay">' . $applicant->getAssessmentDay() . '</span></p>
                    <p class="detail">Assessment Time: <span id="assessmentTime">' . $applicant->getAssessmentTime() . '</span>
                ...
                <section>
                    ...
                    <p class="detail">Laptop deposit paid: <span id="laptopDeposit"span>' . $applicant->getLaptopDeposit() . '</p>
                    <p class="detail">Laptop number: <span id="laptopNum">' . $applicant->getLaptopNum() . '</span></p>
                    <p class="detail">Kit collection date: <span id="kitCollectionDay"span>' . $applicant->getKitCollectionDay() . '</p>
                    <p class="detail">Kit collection time: <span id="kitCollectionTime"span>' . $applicant->getKitCollectionTime() . '</p>
