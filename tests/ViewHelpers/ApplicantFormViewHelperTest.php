...
class ApplicantFormViewHelperTest extends TestCase
{
    public function testSuccessApplicantForm()
    {
        ...
        $expected = '<optgroup label="' . $stages['string']['title'] . '"><option name="stageId" value="' . $stages['string']['id'] . " " . $stageOptions['stringThree']['id'] . '">'. $stageOptions['stringThree']['option'] . '</option></optgroup><option class="stageDropdown" name="stageId" value="' . $stages['stringTwo']['id'] . '">' . $stages['stringTwo']['title'] . '</option>';
