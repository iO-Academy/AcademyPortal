...
class ApplicantFormViewHelperTest extends TestCase
{
    public function testSuccessApplicantForm()
    {
        ...
        $expected = '<optgroup label="dummy-title">' .
                    '<option data-stage="1" data-student="0" name="stageId" value="1 1" selected>' .
                    'dummy-option</option>' .
                    '</optgroup>' .
                    '<option data-stage="2" data-student="1" class="stageDropdown" name="stageId" value="2">' .
                    'dummy-title-Two</option>';
