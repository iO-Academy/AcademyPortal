...
class StudentApplicationFormViewHelperTest extends TestCase
{
    ...
    public function testSuccessDisplayForm()
    {
        ...
        $expected = '<div class="studentApplicationFormPages hidden" id="1"><div class="row "><input id="name" ' .
            ...
            'id="nameError" data-field="name" class="alert hidden formItem_alert">Field Required.</div><div class="row">' .
        '<input id="email" name="email" type="email" class="submitApplicant" placeholder="Email" class="form-control">' .
        ...
        'class="alert hidden formItem_alert">Field Required.</div><div class="row"><select id="gender" name="gender" ' .
        'class="form-control submitApplicant" ><option value="" disabled selected>Gender</option><option value="1">' .
        'male</option></select></div><div id="genderError" class="alert hidden formItem_alert">Field Required.</div>' .
        '<div class="row buttons"><button class="btn btn-lg" disabled>Prev</button><button class="nextButton btn btn-lg"' .
        ' data-buttontype="next" type="submit" for="studentApplicationForm" value="2" data-page="1">Next</button></div>' .
        '</div><div class="studentApplicationFormPages hidden" id="2"><div class="row"><select id="backgroundInfo" ' .
        'name="backgroundInfoId" class="form-control submitApplicant"><option value="" disabled selected>Background' .
        '</option><option value="1">hello</option></select></div><div id="backgroundError" '.
        'class="alert hidden formItem_alert">Field Required.</div><div class="row form-group"><label for="whyDev" ' .
        ...
        '</div><div id="whyDevError" class="alert hidden formItem_alert"></div></div><div class="row buttons"><button ' .
        ...
        '</div></div><div class="studentApplicationFormPages hidden" id="3"><div class="row"><label for="pastCoding" ' .
        'class="label-control withTooltip">Any past coding experience?<p class="pastCodingTooltip" data-toggle="tooltip"' .
        ...
        '?</p></label><textarea id="pastCoding" name="codeExperience" placeholder="Most people write a few sentences" ' .
        'class="form-control submitApplicant" rows="5"></textarea><div id="codeExperienceError" class="alert hidden ' .
        'formItem_alert"></div></div><div class="row buttons"><button class="btn btn-lg prevButton" value="2">Prev' .
        ...
        'class="alert hidden formItem_alert"></div><p id="pageFourSmallPrint">Some course dates may also be offered ' .
        'with a remote option. Contact us to find out more.</p></div><div class="row"><label> How did you hear about us?' .
        ...
        '<div class="row"><label for="eligibilityTooltip"class="label-control withTooltip"><div class="ukEligibility">' .
        '<input name="eligible"type="checkbox" class="submitApplicant"value="I am eligible to live and work in the ' .
        'UK"/>I am eligible to live and work in the UK</div><div class="toolTipContainer"><p class="eligibilityTooltip" ' .
        ...
        'block;"></div></label></div><div id="UKWorkError" class="alert hidden formItem_alert"></div><div class="row">' .
        ...
        '/terms-conditions" target="_blank">terms and conditions</a> and <a href="https://io-academy.uk/privacy-policy" ' .
        'target="_blank">privacy policy</a>.</p><label><input type="checkbox" class="submitApplicant" value="I accept ' .
        ...
        'data-buttontype="next" type="submit" for="studentApplicationForm" value="5" data-page="4">Next</button></div>' .
        ...
        'between you and one of our trainers.</li><li>After your chat with a trainer, we will be in touch within five ' .
