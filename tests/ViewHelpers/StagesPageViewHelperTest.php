...
class StagesPageViewHelperTest extends TestCase
{
    ...
    public function testSuccessNoOptionsDisplayStages()
    {
        ...
        <pclass="stageTitle">Stage1test</p><formdata-id="1"class="stagesTableFormform-inline"><div>
        <label>Studentstage:<inputtype="checkbox"name="student"><iclass="glyphiconglyphicon-educationtext-success">
        ...
        <divclass="optionsContainerhidden"data-stageId="1"><divclass="optionContainermultiOptionsContainer">
        ...
        data-stageid="1"value="Submit"></form></div></div></td><tdclass="col-xs-2text-center">
        <aclass="toggleEditForm">Edit</a></td><tdclass="col-xs-2text-center">
        <adata-id="1"class="text-dangerdeletedisabled">Delete</a></td><tdclass="col-xs-2text-center">
        <aclass="toggleEditOptions"data-stageId="1">Options</a></td><tdclass="col-xs-2text-centerstageLock"
        data-stageId="1"data-locked="1"><iclass="fasfa-lock"></i></td></tr>';
    ...
    public function testSuccessOptionsDisplayStages()
    {
        ...
        <inputtype="submit"class="optionAddSubmitbtnbtn-success"data-stageid="1"value="Submit"></form></div>
        </div></td><tdclass="col-xs-2text-center"><aclass="toggleEditForm">Edit</a></td><tdclass="col-xs-2text-center">
        <adata-id="1"class="text-dangerdeletedisabled">Delete</a></td><tdclass="col-xs-2text-center">
